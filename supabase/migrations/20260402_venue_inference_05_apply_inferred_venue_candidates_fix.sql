-- Venue inference apply RPC fix (v1)
-- Fixes PL/pgSQL ambiguity between OUT params (returns table columns) and column names
-- when using `RETURNING tournament_id, venue_id`.
--
-- This is safe and does not change inference semantics.
