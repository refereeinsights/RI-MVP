-- Extend TI Quick Venue Check metrics RPC with post-submission Insider signup prompt events.
...
select jsonb_build_object(
  ...
  'totalSignupPromptShown', (select count(*)::integer from events where event_type = 'Venue Quick Check Signup Prompt Shown'),
  'totalSignupClicked', (select count(*)::integer from events where event_type = 'Venue Quick Check Signup Clicked'),
  'totalSignupDismissed', (select count(*)::integer from events where event_type = 'Venue Quick Check Signup Dismissed'),
