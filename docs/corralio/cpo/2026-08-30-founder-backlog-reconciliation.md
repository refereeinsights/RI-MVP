...
| 3.6B Phase 3B — HotelPlanner booking → lodging → routing origin | Un-deferred 2026-08-30, evidence diagnostic filed, Stage 1 prompt not yet written | `corralio-hotelplanner-phase3b-evidence-diagnostic-prompt.md` | Status-contract enumeration + cancellation-window live test results |
