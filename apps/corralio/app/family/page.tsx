...
export default async function FamilyPage() {
  ...
  if (!viewer) redirect("/");
  const { familyChildren, familyTeams, connectedSources, sourceCount, originAddress, planningTimezone, freshnessNow } = await loadFamilyData(viewer);
  return (
    <ProductShell activeSection="family">
      ...
      <FamilySection familyChildren={familyChildren} teams={familyTeams} originAddress={originAddress} planningTimezone={planningTimezone} />
