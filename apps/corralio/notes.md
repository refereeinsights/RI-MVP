...
- Added read-only catalog verification and rollback-only behavioral verification SQL. No migration was applied and no real calendar feed, production cron route, or production record was touched. Validation passed 28 focused/shared schedule tests, Corralio TypeScript, lint, production build, and diff checks. No new table or index was added.
