...
export default async function VenuesPage({
  ...
  const rawVenues = ((venuesData ?? []) as unknown) as VenueRow[];
    ...
    <main className="pitchWrap tournamentsWrap">
      <section className="field tournamentsField">
        <div className="headerBlock brandedHeader">
          ...
          <p className="subtitle" style={{ marginTop: 8, maxWidth: 720, fontSize: 14, lineHeight: 1.5 }}>
            Browse tournament venues by sport, location, and month. Listings focus on practical planning details and official links.
          </p>
        ...
        <form className="filters" method="GET" action="/venues">
          ...
          <div className="actionsRow">
            <button type="submit" className="smallBtn">Apply</button>
            <a className="smallBtn" href="/venues">Reset</a>
          </div>
        </form>
          ...
          <div className="cards">
            <article className="card card-grass">
              <div className="cardHeader">
                <div>
                  <div className="cardTitle" style={{ fontSize: 18 }}>No venues found</div>
