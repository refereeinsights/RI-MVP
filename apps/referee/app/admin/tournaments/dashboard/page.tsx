...
export default async function TournamentsDashboard({ searchParams }: { searchParams: Search }) {
  ...
  const tiOutreachHref = buildTiAdminSsoUrl({
    tiAdminBaseUrl,
    ...
    <div style={{ padding: 24 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 12, marginBottom: 12 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center", marginBottom: 8 }}>
          ...
          <a href={tiOutreachHref} target="_blank" rel="noreferrer" style={{ fontSize: 12, fontWeight: 700, color: "#1d4ed8", textDecoration: "none" }}>
