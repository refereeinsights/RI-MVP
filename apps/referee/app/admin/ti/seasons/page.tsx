...
export default async function TiSeasonsReviewPage({ searchParams }: PageProps) {
  ...
  const action = asOneOf(
    searchParams?.action,
    ["all", "updated", "updated_existing_2027", "needs_review", "no_2027_found", "possible_duplicate", "failed_url"],
    "all"
  );
  ...
  const scans: ScanRow[] = (scansRes.data ?? []) as any;
    ...
    <div style={{ padding: 20, maxWidth: 1250, margin: "0 auto" }}>
      ...
      >
        ...
        <div style={{ marginTop: 8, display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
          ...
          {["all", "updated", "updated_existing_2027", "needs_review", "no_2027_found", "failed_url"].map((v) => (
            <Link
              key={v}
