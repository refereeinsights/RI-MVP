...
export default async function TiClicksPage() {
  ...
  const events: Array<{ key: string; label: string }> = [
    ...
    { key: "weekend_planner_viewed", label: "Weekend planner: page viewed" },
    { key: "weekend_planner_auth_required_viewed", label: "Weekend planner: auth required viewed" },
    { key: "weekend_planner_create_account_clicked", label: "Weekend planner: create account clicked" },
    { key: "weekend_planner_sign_in_clicked", label: "Weekend planner: sign in clicked" },
    { key: "weekend_planner_loaded", label: "Weekend planner: loaded" },
    { key: "weekend_planner_empty_state_viewed", label: "Weekend planner: empty state viewed" },
    { key: "weekend_planner_contextual_cta_viewed", label: "Weekend planner: contextual CTA viewed" },
    { key: "weekend_planner_contextual_cta_clicked", label: "Weekend planner: contextual CTA clicked" },
    { key: "planner_guest_share_panel_viewed", label: "Planner guest share: panel viewed" },
    { key: "planner_guest_share_created", label: "Planner guest share: created" },
    { key: "planner_guest_share_copied", label: "Planner guest share: copied" },
    { key: "planner_guest_share_disabled", label: "Planner guest share: disabled" },
    { key: "planner_guest_share_regenerated", label: "Planner guest share: regenerated" },
    { key: "planner_calendar_feed_panel_viewed", label: "Planner calendar feed: panel viewed" },
    { key: "planner_calendar_feed_created", label: "Planner calendar feed: created" },
    { key: "planner_calendar_feed_revealed", label: "Planner calendar feed: revealed" },
    { key: "planner_calendar_feed_copied", label: "Planner calendar feed: copied" },
    { key: "planner_calendar_feed_disabled", label: "Planner calendar feed: disabled" },
    { key: "planner_calendar_feed_regenerated", label: "Planner calendar feed: regenerated" },
    { key: "team_hotel_cta_viewed", label: "Team hotel: CTA viewed" },
    { key: "team_hotel_cta_clicked", label: "Team hotel: CTA clicked" },
    { key: "team_hotel_request_started", label: "Team hotel: request started" },
    { key: "team_hotel_request_submitted", label: "Team hotel: request submitted" },
    // Conversion
