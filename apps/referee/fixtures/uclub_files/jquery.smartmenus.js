...
(function(factory) {
	...
	$.fn.smartmenus.defaults = {
		...
		subMenusMinWidth:	'12em',		// min-width for the sub menus (any CSS unit) - if set, the fixed width set in CSS will be ignored
		...
		showFunction:		function($ul, complete) { $ul.slideDown(250, complete); },		// custom function to use when showing a sub menu (the default is the jQuery 'show')
