  ...
  return (
    <div>
      <nav aria-label="Admin navigation" style={wrapperStyle}>
        ...
        <Link href="/admin/dashboard-email" style={linkStyle}>
          Dashboard Email
        </Link>
        ...
        <Link href="/admin/ti/quality" style={linkStyle}>
          TI Quality
        </Link>
        <Link href="/admin/ti/discovery" style={linkStyle}>
          TI Discovery
        </Link>
        <Link href="/admin/ti/seasons" style={linkStyle}>
          TI Seasons
        </Link>
