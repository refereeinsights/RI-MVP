...
type CanonicalPlannerPageType = "tournament" | "tournament_hotels" | "venue" | "book_travel" | "team_hotel_booking" | "planner_entry" | "planner" | "auth" | "other";
...
type TeamHotelTrackingIdentity = {
  session_id?: string | null;
  anonymous_visitor_id?: string | null;
  user_id?: string | null;
  source_surface?: TeamHotelSourceSurface | null;
...
export type TiAnalyticsEventPropertiesByName = {
  ...
  hotel_cta_clicked: {
    ...
    cta_placement: string;
    flow_type: "direct_outbound" | "search_then_outbound";
    page_type: "venue" | "tournament" | "tournament_hotels" | "planner" | "other";
  ...
  hotel_card_click: HotelMeasurementContext & {
    ...
    source_page_type?: "tournament_hotels";
    cta_placement?: string;
    lodging_search_id?: string | null;
    outbound_request_id?: string | null;
    outbound_attribution_id?: string;
  };
  hotel_pin_click: HotelMeasurementContext & {
    page_type: "venue_map";
    tournament_id: string;
    tournament_slug: string;
    venue_id: string | null;
  ...
  hotel_checkout_handoff: HotelMeasurementContext & {
    page_type: "venue_map";
    tournament_id: string;
    tournament_slug: string;
    venue_id: string | null;
    ...
    source_page_type: "venue_map";
    cta_placement: string;
    source: "hotel_pin_click" | "hotel_card_click";
    checkin: string;
    checkout: string;
    outbound_request_id: string | null;
    outbound_attribution_id: string;
  ...
  tournament_hotels_page_viewed: HotelMeasurementContext & {
    ...
    sport: string | null;
    venue_count: number;
    searchable_venue_count: number;
    has_valid_venues: boolean;
    initial_date_source: "tournament" | "booking_safe_fallback" | "unavailable";
  ...
  hotels_click: HotelMeasurementContext & {
    page_type: "venue_map";
    tournament_id: string;
    tournament_slug: string;
    venue_id: string;
  ...
  weekend_planner_viewed: PlannerCanonicalContext & {
    surface: "planner";
    source_page_type: "planner";
    auth_state: PlannerAuthState;
    entitlement: PlannerEntitlement;
  };
  weekend_planner_entry_viewed: PlannerCanonicalContext & {
    surface: "tournament";
    source_page_type: "tournament";
    auth_state: PlannerAuthState;
    entitlement: PlannerEntitlement;
  ...
  weekend_planner_auth_gate_viewed: PlannerCanonicalContext & {
    surface: "planner";
    source_page_type: "planner" | "tournament";
    auth_state: PlannerAuthState;
    entitlement: PlannerEntitlement;
    action_surface?: "entry_cta" | "planner" | "weekend_plan";
  };
  weekend_planner_auth_started: PlannerCanonicalContext & {
    surface: "planner";
    source_page_type: "planner" | "tournament";
  ...
  weekend_planner_first_action: PlannerCanonicalContext & {
    surface: "planner";
    source_page_type: "planner" | "tournament";
    auth_state: PlannerAuthState;
    entitlement: PlannerEntitlement;
  ...
  weekend_planner_empty_state_viewed: PlannerCanonicalContext & {
    surface: "planner";
    source_page_type: "planner";
    auth_state: PlannerAuthState;
    entitlement: PlannerEntitlement;
  ...
  weekend_planner_contextual_cta_clicked: PlannerCanonicalContext & {
    surface: PlannerActivationSurface;
    source_page_type: PlannerSourcePageType;
    cta_type: PlannerCtaType;
    auth_state?: PlannerAuthState;
  ...
  team_hotel_landing_viewed: PlannerCanonicalContext &
  ...
  team_hotel_header_cta_viewed: TeamHotelTrackingIdentity & {
    ...
    auth_state: PlannerAuthState;
    cta_label: string;
    current_page_type?: CanonicalPlannerPageType | "other" | null;
    current_page_path?: string | null;
  };
  team_hotel_header_cta_clicked: TeamHotelTrackingIdentity & {
    surface: "global_header";
    source_page_type: "other";
    cta_type: "team_hotel";
    auth_state: PlannerAuthState;
  ...
  team_hotel_cta_viewed: PlannerCanonicalContext & {
    surface: "team_hotel" | "travel" | "tournament" | "tournament_hotels" | "venue";
    source_page_type: "planner" | "book_travel" | "travel" | "tournament" | "tournament_hotels" | "venue" | "team_hotel_booking";
    cta_type: "team_hotel";
    auth_state: PlannerAuthState;
    entitlement: PlannerEntitlement;
    context_type: "team_hotel";
  } & TeamHotelTrackingIdentity & TeamTravelEligibilityProperties;
  team_hotel_cta_clicked: PlannerCanonicalContext & TeamHotelTrackingIdentity & TeamTravelEligibilityProperties & (
    | {
    ...
    | {
        ...
        source_page_type: "tournament_hotels";
        cta_type: "team_hotel";
        cta_placement: "tournament_hotels_team_block";
        context_type: "team_hotel";
        date_source: "tournament" | "booking_safe_fallback" | "unavailable" | "user_adjusted";
      }
  );
