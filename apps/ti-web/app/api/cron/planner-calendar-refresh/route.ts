...
import { runPlannerCalendarRefreshCronJob } from "@/lib/plannerCalendarRefreshJob";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";
export const revalidate = 0;

const LOCK_KEY = "ti_planner_calendar_refresh_v1";
...
export async function GET(req: Request) {
  ...
  try {
    const result = await runPlannerCalendarRefreshCronJob();
